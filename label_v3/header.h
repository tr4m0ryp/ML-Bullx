...
struct curl_slist* set_axiom_request_headers(void) {
    ...
    headers = curl_slist_append(headers, "Cookie: auth-refresh-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZWZyZXNoVG9rZW5JZCI6Ijk0OGEzYzQ4LTQ3MGEtNDk1Zi1iNjY1LWQ2MzZhYWJmMDY4OCIsImlhdCI6MTc1NzA0OTg3M30.GuuLkg0vKVc7pVebbe-M_KXVIeJ8ZiSm0nAoB_VKRcI; auth-access-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRoZW50aWNhdGVkVXNlcklkIjoiNzk2MDBkZGEtNjQyYy00MzdlLThjZDYtNjU2NjNhYjNmMjFiIiwiaWF0IjoxNzU3MDQ5OTExLCJleHAiOjE3NTcwNTA4NzF9.r8Rq2gE20Svtthpy8H4ltb80GGp3nfjNO1W72KPqoFk ");
