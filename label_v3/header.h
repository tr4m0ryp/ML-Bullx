...
struct curl_slist* set_axiom_request_headers(void) {
    ...
    headers = curl_slist_append(headers, "Cookie: auth-refresh-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZWZyZXNoVG9rZW5JZCI6ImRhMzg3YTVkLTNmNTYtNDAxMS05NzQ2LTk5YmIxOTgzOGFmNSIsImlhdCI6MTc1NjUxMzA3MH0.eVkpdTeuyo_Mnz0n_vOo4m6Uhzxtqts5Ao2tFPUs31E; auth-access-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRoZW50aWNhdGVkVXNlcklkIjoiZTE2ZDI5YWUtYTg5Mi00YzU2LWJiNWEtMTNhZjllNzQzNTBiIiwiaWF0IjoxNzU2NTEzMDcwLCJleHAiOjE3NTY1MTQwMzB9.msVcACUappyHwPUWTlsCo4tgX-g2Q-US2FgV6pma3Qs");
