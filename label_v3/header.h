...
struct curl_slist* set_axiom_request_headers(void) {
    ...
    headers = curl_slist_append(headers, "Cookie: auth-refresh-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZWZyZXNoVG9rZW5JZCI6IjY4NGIwNWJkLWVlZTctNGFhMS1hZDM4LTQ1MmRhZGE3YTIyNyIsImlhdCI6MTc1NjYwMDc0OH0.tGdAXwuntQtMUa1zNMp2_Q6hZXR0Ml6V2iDIOywUxQc; auth-access-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRoZW50aWNhdGVkVXNlcklkIjoiZGFmYzkzMjctMzliNy00ODhhLWE3ZDUtMjg1NGZhY2ZhMTE4IiwiaWF0IjoxNzU2NjAxMTg4LCJleHAiOjE3NTY2MDIxNDh9.7R9_EmzJM4epiloayYoMmE3vf1uYT_WZvlLuz7Z0NQU");
